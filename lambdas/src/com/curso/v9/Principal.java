...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("***SUELDO MAYOR A 20.00***");
		show(listaEmpleados, e -> e.getSueldo()>20);
		...
		System.out.println("***LONGITUD NOMBRE MAYOR A 6***");
		showNombres(nombres, n -> n.length()>6);

	}
	
	static void showNombres(List<String> lista, Predicado<String> pre ) {
		for(String n : lista) {
	...
	static void show(List<Empleado> lista, Predicado<Empleado> pre ) {
		for(Empleado n : lista) {
			boolean res = pre.probar(n); //EJECUCION DE LA LAMBDA
			System.out.println(n);
			System.out.println("Resultado: "+res);
		}	
